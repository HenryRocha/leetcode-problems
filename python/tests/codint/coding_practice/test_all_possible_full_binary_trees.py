...
from src.coding_interviews.coding_practice.n0894_all_possible_full_binary_trees import Solution, TreeNode


def stringify(node: TreeNode):
    if not node:
        return ""
